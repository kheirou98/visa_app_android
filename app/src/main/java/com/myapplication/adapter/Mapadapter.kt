...
class Mapadapter(context: Context, var DocsName: ArrayList<String>,var listes : ArrayList<String>,view : View) : RecyclerView.Adapter<Mapadapter.MyViewHolder>() {

    var mContext = context
    var textview = view.findViewById<TextView>(R.id.textView)
    var searchview = view.findViewById<SearchView>(R.id.searchView)
    var recyclerview = view.findViewById<RecyclerView>(R.id.recyclerviewmap)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.map_item, parent, false)
