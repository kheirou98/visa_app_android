...
class RegisterFormAdapterPays(context: Context, var DocsName: ArrayList<String>, var listes : ArrayList<String>, view : View) : RecyclerView.Adapter<RegisterFormAdapterPays.MyViewHolder>() {

    var mContext = context
    var textview = view.findViewById<TextView>(R.id.textViewpays)
    var searchview = view.findViewById<android.support.v7.widget.SearchView>(R.id.searchViewpays)
    var recyclerview = view.findViewById<RecyclerView>(R.id.recyclerviewpays)
