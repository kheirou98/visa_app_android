...
import com.myapplication.controller.Compte
...
object NewMessageNotification {
     ...
     */
    private val NOTIFICATION_TAG = "Nouvelle notification"
 ...
 * Notification design guidelines](https://developer.android.com/design/patterns/notifications.html) when doing so.
    ...
    fun notify(
        context: Context,
        exampleString: String, msgString:String ,number: Int
    ) {
        val res = context.resources
        var sharedPreference= SharedPreference(context)
        var ident=sharedPreference.getValueString("id_user_visa")
        var nom=sharedPreference.getValueString("nom_visa")
        var prenom= sharedPreference.getValueString("prenom_visa")
        ...
        val text = res.getString(
            R.string.new_message_notification_placeholder_text_template, msgString
        )
        ...
        val builder = NotificationCompat.Builder(context)
            ...
            .setSmallIcon(R.drawable.logomgs)
            ...
            .setContentIntent(
                PendingIntent.getActivity(
                    context,
                    0,
                    (Intent(context, Compte::class.java).apply{putExtra("id",ident);
                            putExtra("nom",nom);
                ...
                PendingIntent.getActivity(
                    ...
                    Intent.createChooser(
                        Intent(Intent.ACTION_SEND)
                            .setType("text/plain")
                            .putExtra(Intent.EXTRA_TEXT, "mgs visas"), "notification"
                    ),
                    PendingIntent.FLAG_UPDATE_CURRENT
                )
            )
